...
COLOR_THEMES = {
    "default": {
        ...
        "google-meet-unmuted-bg": "google-meet-inactive-bg",
        "google-meet-unmuted-icon": "google-meet-inactive-icon",
        "google-meet-muted-bg": "red",
        "google-meet-muted-icon": "white",
        "google-meet-hangup-bg": "google-meet-muted-bg",
    ...
    "dracula": {
        ...
        "google-meet-unmuted-icon": "icon-inactive",
        "google-meet-muted-bg": "tile-bg",
        "google-meet-muted-icon": "icon-alert",
